			...
			<div class="row">
				<c:forEach items="${peliculas}" var="pelicula">
					<div class="col-xs-12 col-sm-6 col-md-3">
						...
						<h4>
							<span class="badge badge-success">${pelicula.clasificacion}</span>
							<span class="badge badge-success">${pelicula.duracion}</span> <span
								class="badge badge-success">${pelicula.genero}</span>
						</h4>
						<%-- <p>
